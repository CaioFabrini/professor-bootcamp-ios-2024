//
//  main.swift
//  Coleções + Estruturas de Repetição
//
//  Created by Caio Fabrini on 17/06/24.
//
...
let listaAplicativos: [String] = ["Whatzapp",
                                  "Facebook",
                                  "Instagram"]
//print(listaAplicativos[1])
...
var nomesCompletos: [String: String] = ["Caio": "Fabrini",
                                        "Albert": "Fazion",
                                        "Marcos": "Alberto"]

//print(nomesCompletos["Caio"] ?? "Não encontramos essa chave")
...
let mercado: [String: Int] = ["Laranja": 10,
                              "Melancia": 2,
                              "Abacate": 4]

//print(mercado["Laranja"] ?? 0)
...
//var listaExercicio1 = [Int]()
var listaExercicio1: [Int] = []
listaExercicio1.append(1)
listaExercicio1.append(2)
listaExercicio1.append(3)

//for value in listaExercicio1 {
//  print("O valor é: \(value)")
//}

// MARK: Exercício 2: Crie um dicionario String:String com 3 itens. Imprima utilizando o for a chave de cada um deles.

var listaNomeCompleto: [String: String] = ["Caio": "Fabrini",
                                           "Bárbara": "Brigolin",
                                           "Alfred": "Silva"]

//for nome in listaNomeCompleto {
//  print("A chave é: \(nome.key)")
//}


// MARK: Exercício 3: Adicionar chave e valor em um dicionário e imprimir ambos utilizando o for print("\(chave): \(valor)")

// listaNomeCompleto["Bianca"] = "Fabrini"
//listaNomeCompleto.updateValue("Bianca", forKey: "Fabrini")
...
var list: [String] = ["Caio", "Matheus", "Jorge"]
//list.reverse() // estou pedindo para a lista ficar ao contrario
var listReversed: [String] = list.reversed()  // retorno de lista ao contrario

//for value in listReversed {
//  print("O valor é: \(value)")
//}
...
var listaExercicio5: [Int] = [1,2,3,4,5]
var soma: Int = 0
