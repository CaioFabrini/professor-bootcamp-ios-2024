...
//
//  Created by Caio Fabrini on 12/06/24.
//
...
//
validaDesconto(valorTotal: "15000")
...
// 1-  forma de criar com if básico
...
// 2-  forma de criar com if ternário
func mediaAlunos(nota1: Double, nota2: Double) -> String {
  let media = (nota1 + nota2) / 2
...
let totalDesconto: Double = desconto(total: 500)
print(totalDesconto)
...
var corSemaforo: String = semaforo(cor: "teste")
//print(corSemaforo)
...
let valor: String = compararValores(valor1: 10, valor2: 20)
print(valor)


print(compararValores(valor1: 20, valor2: 20))
...
print(verificarAcesso(senha: "1234", hora: 15))
