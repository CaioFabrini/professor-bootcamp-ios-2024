...
final class LoadingLottie: UIView {
  ...
  lazy var animationLottieView: LottieAnimationView = {
    let loading = LottieAnimationView(name: "empty-animation") // Espera o json com esse nome
  ...
  func configConstraints() {
    NSLayoutConstraint.activate([
      ...
      animationLottieView.heightAnchor.constraint(equalToConstant: 400),
      animationLottieView.widthAnchor.constraint(equalToConstant: 400),
